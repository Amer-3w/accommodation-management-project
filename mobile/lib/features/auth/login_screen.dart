            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Text('Login to continue your search', style: TextStyle(color: StudyHubColors.secondaryText)),
                  ...
                  StudyHubTextField(
                    ...
                    validator: (value) {
                      ...
                      if (text != adminLogin && !RegExp(r'^[^@\s]+@[^@\s]+\.[^@\s]+$').hasMatch(text)) return 'Enter a valid email';
                      return null;
                    },
                  ),
                  ...
                  Align(
                    ...
                    child: TextButton(onPressed: () => Navigator.pushNamed(context, ForgotPasswordScreen.route), child: const Text('Forgot Password?')),
                  ),
                  ...
                  const _SocialButton(label: 'Continue with Google', color: Color(0xFFDB4437), letter: 'G'),
                  const SizedBox(height: 10),
                  const _SocialButton(label: 'Continue with Microsoft', color: Color(0xFF2F2F2F), letter: 'M'),
                  const SizedBox(height: 10),
                  const _SocialButton(label: 'Continue with Facebook', color: Color(0xFF1877F2), letter: 'f'),
...
class _SocialButton extends StatelessWidget {
  const _SocialButton({required this.label, required this.color, required this.letter});
  final String label;
  final Color color;
  final String letter;
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      ...
      onPressed: () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('$label requires provider credentials.'))),
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        CircleAvatar(radius: 12, backgroundColor: color, child: Text(letter, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 12))),
