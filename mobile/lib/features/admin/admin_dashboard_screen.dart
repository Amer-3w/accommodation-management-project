...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  final items = const [
    ...
    AdminSidebarItem(
        'analytics', Icons.analytics_outlined, 'Reports / Analytics'),
    ...
    AdminSidebarItem(
        'support', Icons.support_agent_outlined, 'Support Messages'),
    AdminSidebarItem(
  ...
  Widget build(BuildContext context) {
              ...
              child: Column(
                children: [
                  AdminHeader(
                    ...
                    onNotifications: () =>
                        setState(() => selected = 'notifications'),
                    onLogout: _logout,
                    onSelect: (value) => setState(() => selected = value),
                  ),
    ...
    // 3. Assemble the master scaffolding view layout
    return Scaffold(
      backgroundColor: EduStayColors.background,
      body: Directionality.of(context) == TextDirection.rtl
          ? Row(children: [contentArea, sidebar])
          : Row(children: [sidebar, contentArea]),
    );
  }
