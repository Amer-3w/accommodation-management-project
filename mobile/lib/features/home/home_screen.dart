...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final firstName =
        (user?.name.trim().isNotEmpty == true ? user!.name : 'Student')
            .split(' ')
            .first;
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: const Row(children: [
                            Icon(Icons.search,
                                color: EduStayColors.secondaryText, size: 20),
                            SizedBox(width: 10),
                            Text('Search location or property...',
                                style: TextStyle(
...
class _HomeHeader extends SliverPersistentHeaderDelegate {
  ...
  @override
  bool shouldRebuild(covariant _HomeHeader oldDelegate) =>
      maxHeight != oldDelegate.maxHeight || child != oldDelegate.child;
}
